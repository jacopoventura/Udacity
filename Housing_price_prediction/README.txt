The goal of the project is to train a Machine Learning model capable to predict the housing price in California.
This project follows the typical end-to-end procedure of a Machine Learning project:
1. Look at the big picture. Formulate the goal clearly
2. Get the data.
3. Discover and visualize the data to gain insights. 
4. Split dataset into training set and test set.
5. Prepare the data for Machine Learning algorithms: handle NaN, convert text labels into numerical values, scale data
6. Select several ML models and train them. Use cross validation for estimating the performances
7. Select the model and perform fine-tuning.
